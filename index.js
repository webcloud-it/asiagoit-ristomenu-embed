						...
						? html`
								<div class="asit-rime__cat ${tw`flex flex-col gap-4`}">
									...
									category.translations[0].SottotitoloCategoria
										? html`
												<div class="asit-rime__head">
													...
													<div
														class="asit-rime-head__hr ${tw`h-[1px] bg-black opacity-50`}"
													></div>
													${category.translations[0].SottotitoloCategoria
														? html`
																<div
									...
									${category.dishes?.length
										? html`
												<div
													class="asit-rime__dishes ${tw`flex flex-col gap-2 flex-wrap px-4`}"
												>
													${repeat(category.dishes, (dish, dishIndex) =>
														dish.translations?.length
															? html`
																	<div
																		class="asit-rime__dish ${tw`flex flex-row gap-2`}"
																	>
																		<div
																			class="asit-rime-dish__info ${tw`flex-1`}"
																		>
																			${dish.translations[0]
																				.NomePiatto
																				? html`
																						<div
																							class="asit-rime-dish__name ${tw`text-lg`}"
																						>
																							${dish
																								.translations[0]
																								.NomePiatto}
										...
										? html`
												<div class="asit-rime__foot">
													${category.translations[0].PrezzoTotale
														? html`
																<div
																	class="asit-rime-foot__total ${tw`text-center`}"
																>
																	${category.translations[0]
																		.PrezzoTotalePersone
																		? html`
									...
									${category.translations[0].TestoCondizioni
										? html`
												<div
													class="asit-rime__notes ${tw`text-center opacity-70 text-sm`}"
												>
													${category.translations[0].TestoCondizioni}
												</div>
										  `
